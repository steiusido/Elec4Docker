...
import ResizablePagePreview from "./ResizablePagePreview";

type DepartmentAdminEditorProps = {
  code: DeptCode;
};

export default function DepartmentAdminEditor({ code }: DepartmentAdminEditorProps) {
